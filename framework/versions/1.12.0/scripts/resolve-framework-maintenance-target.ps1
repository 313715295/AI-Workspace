...
try {
    ...
    $rootFields = @('schemaVersion','id','displayName','controlPlaneLayout','repositoryRoot','frameworkVersion','frameworkToolBackend','routineExcludedPaths','frameworkCapabilities','frameworkTarget')
    ...
    foreach ($required in @('README.md','framework/versions/1.12.0/RECOVERY_CORE.md','framework/versions/1.12.0/LOAD_MANIFEST.json','framework/versions/1.12.0/TOOLCHAIN.json','framework/versions/1.12.0/FRAMEWORK_MAINTENANCE.md','AGENTS.md')) {
