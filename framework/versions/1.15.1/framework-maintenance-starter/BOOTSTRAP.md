...
2. Invoke `PROCESS_REQUIREMENTS_RESOLVE/DISCOVER` over the complete sealed metadata catalog plus current corrections and policy before loading normative modules. Read only the exact complete Markdown blocks returned by the receipt.
