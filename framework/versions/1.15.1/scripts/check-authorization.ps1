...
if ([string]$package.frameworkVersion -cne '1.15.1') { Add-Reason $reasons 'FRAMEWORK_VERSION' }
...
if ([int]$package.schemaVersion -in @(1,3)) {
    try {
        ...
        if (-not (Test-JsonInteger $schema1Config.schemaVersion) -or [int]$schema1Config.schemaVersion -notin @(3,4) -or
            ...
            ([int]$package.schemaVersion -eq 1 -and [string]$schema1Config.frameworkVersion -cne '1.15.1') -or
