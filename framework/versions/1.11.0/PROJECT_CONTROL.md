...
The 1.11.0 starter makes the current task's `Work route` the loader input. It does not move task state into Framework root, create a consumer record or make the task index a second authority.
