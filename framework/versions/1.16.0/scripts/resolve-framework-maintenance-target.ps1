...
try {
    ...
    foreach ($required in @('README.md','framework/versions/1.16.0/RECOVERY_CORE.md','framework/versions/1.16.0/LOAD_MANIFEST.json','framework/versions/1.16.0/TOOLCHAIN.json','framework/versions/1.16.0/FRAMEWORK_MAINTENANCE.md','AGENTS.md')) {
