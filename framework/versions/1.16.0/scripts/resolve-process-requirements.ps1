...
try{
  ...
  if($mode-ceq'DISCOVER'){
    ...
    if($inputContract-eq3){
      $sourceBindings=[ordered]@{projectConfigIdentity=$composition.projectConfigIdentity;controllerIdentity=$composition.controllerIdentity;correctionsIdentity=$composition.correctionsIdentity;policyIdentity=$composition.policyIdentity;bootstrapManagedIdentity=$composition.bootstrapManagedIdentity;projectCustomIdentity=$composition.projectCustomIdentity;projectAgentsIdentity=$composition.projectAgentsIdentity;projectStandardsIdentity=$composition.projectStandardsIdentity;taskIdentity=$taskIdentity;frameworkVersionIdentity=$composition.frameworkVersionIdentity;releaseManifestIdentity=$composition.releaseManifestIdentity;candidatePilotStateIdentity=$composition.candidatePilotStateIdentity;nativeCatalogIdentity=$composition.nativeCatalogIdentity;correctionCoverageIdentity=$composition.correctionCoverageIdentity}
