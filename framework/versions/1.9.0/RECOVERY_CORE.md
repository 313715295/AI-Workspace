...
2. Read the project's repo-local `.ai-workspace/project.json`, `controller.json` and `BOOTSTRAP.md` strictly.
...
5. Load role, profile, phase, host, topology and configured capability modules in manifest order.
