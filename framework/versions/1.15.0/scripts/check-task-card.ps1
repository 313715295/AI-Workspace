...
if ($schemaMatches.Count -ne 1 -or $taskSchema -notin @('1.5','1.5.2','1.9.0','1.10.0','1.11.0','1.12.0','1.13.0','1.15.0')) { Add-Reason $reasons 'TASK_SCHEMA' }
...
if ($taskSchema -in @('1.13.0','1.15.0')) {
...
if ($taskSchema -in @('1.9.0','1.10.0','1.11.0','1.12.0','1.13.0','1.15.0') -and $profile -ceq 'CRITICAL') {
...
if ($taskSchema -in @('1.5.2','1.9.0','1.10.0','1.11.0','1.12.0','1.13.0','1.15.0') -and $profile -ceq 'CRITICAL') {
