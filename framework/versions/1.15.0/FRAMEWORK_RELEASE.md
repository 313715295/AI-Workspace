...
Framework 1.15.0 is a backward-compatible MINOR from immutable stable 1.14.1 and uses the proportional release flow below.
...
Platform support remains evidence-bound. 1.15.0 claims Windows PowerShell 7 only. Linux/macOS require a later released toolchain declaration and actual conformance evidence.
