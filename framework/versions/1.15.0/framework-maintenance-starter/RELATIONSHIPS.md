...
| Project corrections | CONTROL `.ai-workspace/corrections.json` plus target release exact legacy/native/catalog/source-record coverage | Maintenance recovery and pin adoption | evaluate against explicit pin; retain unknown, ambiguous or source-drifted records; no target control state or second status object |
