...
- Stable Framework versions are immutable. Candidate, stable projection, live roots/CURRENT, directory migration, Git publication and consumer adoption are separate actions.
