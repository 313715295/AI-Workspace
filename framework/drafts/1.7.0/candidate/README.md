...
Candidate completion, independent Review, stable projection, live roots/CURRENT, physical directory migration, each repository's Git publication and every consumer pin remain separate actions.
