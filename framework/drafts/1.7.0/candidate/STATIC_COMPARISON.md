# Framework 1.6.1 versus 1.7.0 candidate

| Concern | 1.6.1 | 1.7.0 candidate |
|---|---|---|
...
The candidate adds no arbitrary cross-repository manager, multi-target transaction, service, ledger, retry/compensation loop or consumer auto-adoption.
