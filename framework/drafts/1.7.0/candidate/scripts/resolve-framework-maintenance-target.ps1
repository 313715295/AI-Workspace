...
try {
    ...
    foreach ($required in @('README.md','framework/versions/1.7.0/RECOVERY_CORE.md','framework/versions/1.7.0/LOAD_MANIFEST.json','framework/versions/1.7.0/FRAMEWORK_MAINTENANCE.md','AGENTS.md')) {
