...
2. 复证项目Git根、旧/新固定版本、Bootstrap受管区、自定义区、日常排除、任务边界和真实dirty边界。
...
5. 升级后立即以新版本完整冷恢复，验证owner、current任务、日常排除、术语权威、权限和Git状态；通过后再精确关闭保留的恢复材料。
