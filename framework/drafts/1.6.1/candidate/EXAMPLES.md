...
- 第一次1.6.1冷恢复验证loader、schema3日常排除结构、controller ID/epoch、owners、current任务，以及bounded Git consumer对排除配置的使用点验证结果。
...
Pocket等大型dirty项目必须在自己的采用任务中另做版本对比；即使1.6.1未来正式发行，也不会自动升级项目。
